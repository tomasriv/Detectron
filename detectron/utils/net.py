...
def initialize_gpu_from_weights_file(model, weights_file, gpu_id=0):
    ...
    for blob in model.params:
        ...
        if (keyname == 'kps_score_lowres_w' or keyname == 'kps_score_lowres_b' or keyname == 'kps_score_w' or keyname == 'kps_score_b' or keyname == 'kps_score_reshaped_w' or keyname == 'keypoint_locations_int32_w' or keyname == 'keypoint_weights_w' or keyname == 'kps_score_reshaped_b' or keyname == 'keypoint_locations_int32_b' or keyname == 'keypoint_weights_b' or keyname == 'kps_score_reshaped' or keyname == 'keypoint_locations_int32' or keyname == 'keypoint_weights'):
            continue
